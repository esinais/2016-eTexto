...
public class StopwordsPortuguese extends Stopwords {
  ...
  static {
    if (m_Stopwords == null) {
      ...
      // m_Stopwords.put("como", dummy); // Ver com Daniela 10/05/2016
      ...
      // m_Stopwords.put("onde", dummy); // Ver com Daniela 10/05/2016
      ...
      // m_Stopwords.put("qual ", dummy);  // Ver com Daniela 10/05/2016
      // m_Stopwords.put("quando", dummy); // Ver com Daniela 10/05/2016
      m_Stopwords.put("quase", dummy);
      m_Stopwords.put("que", dummy);
      // m_Stopwords.put("quem", dummy); // Ver com Daniela 10/05/2016
