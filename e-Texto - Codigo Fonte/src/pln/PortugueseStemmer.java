...
/**
 * Implements a Portuguese stemmer. The algorithm is based on the paper "A
 * Stemming Algorithm for the Portuguese Language" by Vivianne Orengo and Chris
 * Huyck, in Proceedings of the SPIRE, November, 2001. Several rules where
 * updated and many exceptions and special cases where added.
 *
...
public class PortugueseStemmer extends Stemmer implements Serializable {
    ...
    private static Rule[] plural = {
        // -NS
        new PRule("ns", 1, "m", new String[]{"íons", "elétrons", "prótons", "nêutrons", "fótons", "epsilons"}), // EX: uns
        // -ÃES, -ÕES
        ...
        new PRule("eis", 3, "el", new String[]{"fósseis", "táteis", "répteis", "fáceis", "frágeis", "têxteis", "férteis", "inférteis", "voláteis", "inúteis", "dóceis", "indóceis", "estéreis", "hábeis", "inábeis", "portáteis", "débeis", "mísseis", "fúteis", "vibráteis", "verocímeis", "projéteis"}), // EX: móveis
        ...
        new PRule("is", 2, "il", new String[]{"lápis", "cais", "mais", "crúcis", "biquínis", "pois", "depois", "dois", "oásis", "pais", "demais", "ademais", "jamais", "anais", "reis", "leis", "práxis", "quis", "tênis", "sífilis", "pênis", "bois", "grátis", "oásis", "brócolis", "pélvis", "júris", "álcalis", "zumbis", "púbis", "clitóris", "bílis", "bisturis", "íris", "táxis", "alíbis", "guris", "chassis", "abacaxis", "caquis", "sanguis", "croquis", "sambaquis"}), // EX: anis
        // -ES
        new PRule("les", 2, "l", new String[]{"simples", "deles", "aqueles", "daqueles", "controles", "àqueles", "neles", "naqueles", "vales", "peles", "isósceles", "móbiles", "hipérboles", "sístoles", "metrópoles"}),// EX: males
        new PRule("nes", 4, "n", new String[]{"perenes", "autóctones", "microfones", "cabines", "aborígenes", "telefones", "gramofones"}),// EX: cânones
        new PRule("eses", 4, "ês", new String[]{"*teses", "*gêneses", "dioceses"}),// EX: chineses
        new PRule("ses", 1, "s", new String[]{"*pses", "*sses", "*fases", "*frases", "*tases", "*oses", "*teses", "*enses", "*gêneses", "dioceses", "análises", "bases", "crises"}),// EX: ases
        new PRule("res", 1, "r", new String[]{"*bres", "*cres", "*dres", "*fres", "*gres", "*tres", "*vres", "árvores", "softwares", "hardwares", "pires", "escores", "torres", "hectares", "alferes", "alhures", "víveres", "títeres", "alqueires", "porres"}), // EX: ares
        new PRule("zes", 2, "z", new String[]{"fezes", "deslizes", "varizes", "bronzes"}),// EX: vezes
        // -S
        new PRule("s", 1, "", new String[]{"aliás", "pires", "lápis", "cais", "mais", "mas", "menos", "férias", "fezes", "pêsames", "crúcis", "gás", "atrás", "trás", "detrás", "moisés", "através", "convés", "invés", "*ês", "país", "após", "ambas", "ambos", "messias", "oásis", "ônibus", "dois", "duas", "três", "depois", "revés", "seis", "dezesseis", "atlas", "alvíssaras", "anais", "antolhos", "calendas", "cãs", "condolências", "exéquias", "fastos", "núpcias", "mês", "olheiras", "primícias", "víveres", "viés", "demais", "ademais", "jamais", "réis", "grátis", "brócolis", "pélvis", "púbis", "clitóris", "ânus", "bílis", "íris", "isósceles", "simples", "parênteses", "apenas", "vós", "nós", "antes", "pós", "deus", "cós", "status", "caos", "ônus", "vírus", "tônus", "bônus", "versus", "campus", "stress", "corpus", "través"}), // EX: os
    };
    ...
    private static Rule[] feminine = {
        ...
        // -ONA
        new PRule("ona", 3, "ão", new String[]{"*crona", "*erona", "*iona", "*lona", "*nona", "desabona", "abandona", "telefona", "sanfona", "antígona", "mamona", "japona", "corona", "poltrona", "matrona", "manjerona", "dipirona", "destrona", "persona", "unísona", "*cortisona", "*metasona", "monótona", "maratona", "*cetona", "detona", "*oxítona", "apaixona", "azeitona", "*zona"}), // EX: bobona
        ...
        new PRule("esa", 4, "ês", new String[]{"*presa", "*defesa", "despesa", "sobremesa", "turquesa"}), // EX: chinesa
        ...
        // -Ã
        new PRule("ã", 2, "ão", new String[]{"manhã", "amanhã", "maçã", "xamã", "afã", "clã", "*ímã", "divã", "sutiã", "titã", "tucumã", "marzipã"}), // EX: grã
        // -ÉSIMA
            ...
            while ((num = System.in.read()) != -1) {
                ...
                if (Character.isLetter(c)) {
                    ...
                    if (wordBuffer.length() > 0) {
                        String res = ms.stem(wordBuffer.toString());
                        StopwordsPortuguese stop = new StopwordsPortuguese();
                        if (!stop.isStopword(res)) {
...
/**
 * Positive rule: replace suffix for all matching words, however taking into
 * account the exception list
 */
